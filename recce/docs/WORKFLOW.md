...
| **W4 — Progressive disclosure** | ✅ shipped | help grouping (core vs surgical); quickstart on bare invocation | `cli.py` argparse / argspec | help lists core path first | low | discoverability |
